...
public class Input {
	...
	public static Set<String> getWord(int type) throws IOException {
		...
		BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("data/templating/cuewords.txt")));
		String s;
	...
	private static Tree senToNode(String s) {
		Tree node = new Tree();
		node.content = "ROOT";
		node.no = 0;
	...
	private static ArrayList<String> treeToSen(String s) {
		String[] token = s.split(" ");
